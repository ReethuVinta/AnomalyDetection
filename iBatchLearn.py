...
def run(args):
    ...
    print("task_output_space",task_output_space)
    ...
    if args.offline_training:  # Non-incremental learning / offline_training / measure the upper-bound performance
        ...
        for i in range(len(task_names)):
            ...
            # Learn
            print("Learn_batch time")
            agent.learn_batch(train_loader, val_loader)
            print("Learn_batch time ended")
            # Evaluate
...
def get_args(argv):
    ...
    parser.add_argument('--dataset', type=str, default='IDS', help="IDS(default)")
