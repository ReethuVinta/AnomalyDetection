...
def get_split_MNIST_handlers(data_path, use_one_hot=False, validation_size=0,
                             steps=2):
    """This method instantiates 5 objects of the class :class:`SplitMNIST` which
    will contain a disjoint set of labels.

    The SplitMNIST task consists of 7 tasks corresponding to the images with
