...
if os.path.exists(cache_label):
    ...
    with open("./data/distributed/train_data_x.pth", "wb") as f:
        pickle.dump(train_data_x, f)

    with open("./data/distributed/train_data_y.pth", "wb") as f:
        pickle.dump(train_data_y, f)

    with open("./data/distributed/test_data_x.pth", "wb") as f:
        pickle.dump(test_data_x, f)

    with open("./data/distributed/test_data_y.pth", "wb") as f:
