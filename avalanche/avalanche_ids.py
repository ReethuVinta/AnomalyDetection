...
if(path.exists(cache_label)):
    ...
    for i in range(y_test.iloc[:,-1].nunique()):
        ...
        test_label_dict["cat"+str(i)] = y_test[y_test.iloc[:,-1]==i]
...
perm = {'1': [8, 0, 2], '2': [10, 6, 12], '3': [11, 1, 9], '4': [5, 7, 3], '5': [14, 13, 4]} 
...
model = SimpleMLP(num_classes=15,input_size=70,hidden_size=100)
...
eval_plugin = EvaluationPlugin(
    ...
    StreamConfusionMatrix(num_classes=15, save_image=False),
